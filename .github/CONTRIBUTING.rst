...
Thank you for considering contributing to ``torch-adf``!
...
Then get an up to date checkout of the ``torch-adf`` repository:

.. code-block:: bash

    $ git clone git@github.com:jmaces/torch-adf.git

or if you want to use git via ``https``:

.. code-block:: bash

    $ git clone https://github.com/jmaces/torch-adf.git

Change into the newly created directory and **activate your virtual environment**
if you have not done that already. Install an editable version of ``torch-adf``
...
``torch-adf`` was created as a byproduct of a research project and is
...
Thank you again for considering contributing to ``torch-adf``!
...
.. _`Code of Conduct`: https://github.com/jmaces/torch-adf/blob/main/.github/CODE_OF_CONDUCT.rst
.. _changelog: https://github.com/jmaces/torch-adf/blob/main/CHANGELOG.rst
.. _tox: https://tox.readthedocs.io/
.. _reStructuredText: https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html
.. _semantic newlines: https://rhodesmill.org/brandon/2012/one-sentence-per-line/
.. _examples page: https://github.com/jmaces/torch-adf/blob/main/docs/examples.rst
.. _CI: https://travis-ci.com/jmaces/torch-adf
